...
if (isset($_POST['submit'])) {
   ...
   if ($check_cart->rowCount() > 0) {
      ...
      if ($address == '') {
         ...
         $message[] = 'order anda berhasil, pesanan segera diantar...';
      }
   } else {
...
<body>
   ...
   <section class="checkout">
      ...
      <h1 class="title">informasi order</h1>
      ...
      <form action="" method="post">
         ...
         <div class="cart-items">
            ...
            ?>
            <p class="grand-total"><span class="name">harga total :</span><span class="price">Rp<?= $grand_total; ?></span></p>
         ...
         <div class="user-info">
            ...
            <select name="method" class="box" required>
               ...
               <option value="paytm">transfer atm</option>
               <option value="paypal">paypal</option>
            </select>
            <input type="submit" value="konfirmasi order" class="btn <?php if ($fetch_profile['address'] == '') {
                                                                        echo 'disabled';
