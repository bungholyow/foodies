...
<body>
   ...
   <section class="form-container">
      ...
      <form action="" method="post">
         ...
         <input type="text" class="box" placeholder="alamat rumah" required maxlength="50" name="area">
         <input type="text" class="box" placeholder="kecamatan" required maxlength="50" name="town">
         <input type="text" class="box" placeholder="kabupaten" required maxlength="50" name="city">
