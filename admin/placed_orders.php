...
if (isset($_POST['update_payment'])) {
   ...
   $message[] = 'status pembayaran dipudate!';
}
               ...
               <div class="box">
                  ...
                  <form action="" method="POST">
                     ...
                     <div class="flex-btn">
                        ...
                        <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('hapus order?');">hapus</a>
                     </div>
                  </form>
               </div>
         <?php
            ...
            echo '<p class="empty">belum ada pesanan masuk!</p>';
         }
         ?>
