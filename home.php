...
<body>
      ...
      <div class="swiper hero-slider">
         ...
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
               ...
               <div class="image">
                  <img src="images/ngoreng2.png" alt="">
               </div>
            </div>
   ...
   <section class="category">
      ...
      <h1 class="title">pilihan makanan</h1>

      <div class="box-container">

         <a href="category.php?category=instan" class="box">
         ...
         <a href="category.php?category=kue" class="box">
   ...
   <section class="products">
      ...
      <h1 class="title">makanan terbaru </h1>
